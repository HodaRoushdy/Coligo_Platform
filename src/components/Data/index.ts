...
export const AnnoucData: IData[] = [
  ...
  }, 
  {
    ...
    imgAlt: "woman annoucement",
    personName: "Mrs. Salma Ahmed",
    personDesc: "physuc 02",
    annouce:
      "Hello my students, I want to annouce that the next duiz will be within 3 days and will cover the whole unit 2: Add and subtract numbers, Study hard Good luck",
  },
  {
    imgUrl:
      "https://images.pexels.com/photos/207692/pexels-photo-207692.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    imgAlt: "school annoucement",
    personName: "Managemet",
    personDesc: "Math 101",
    annouce:
      "Gooooooooooode morning, warnors that get ready for the day call it is heard each morning by 850 student at good junior High School in Tagamool,Egypt .I just want you ready to our exams and focus on remaining assignments to gain more grades , Good luck warnors",
  },
  {
    imgUrl:
